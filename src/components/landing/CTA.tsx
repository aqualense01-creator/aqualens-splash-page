    ...
    <section className="relative overflow-hidden bg-navy" aria-labelledby="cta-heading">
      ...
      <div className="relative mx-auto max-w-4xl px-4 py-20 text-center text-navy-foreground sm:px-6 sm:py-24">
        <Reveal>
          ...
          <h2 id="cta-heading" className="mt-5 font-display text-3xl font-bold text-balance sm:text-4xl md:text-5xl">
          ...
          <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
            <a href="/app/live">
              <Button size="lg" className="group h-12 w-full gap-2 bg-primary px-6 text-primary-foreground shadow-glow hover:bg-primary/90 sm:w-auto">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-x-5 gap-y-2 text-[12px] text-white/70">
            ...
            <span className="text-white/30">·</span>
            <a href="/app/support" className="hover:text-white">Support</a>
            <span className="text-white/30">·</span>

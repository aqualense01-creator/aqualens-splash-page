...
export const MOCK_PONDS: MockPond[] = [
  {
    id: "p1", name: "Pond 1 — Rui", species: "Rui (Rohu)", status: "good",
    do_mg_l: 6.8, ph: 7.4, temp_c: 28.6, turbidity_ntu: 18, salinity_ppt: null, ammonia_mg_l: 0.08,
    battery_pct: 86, signal_pct: 92, farm_id: "f1",
    last_updated: m(3), device_status: "online",
    trend: [6.2, 6.4, 6.5, 6.6, 6.7, 6.9, 7.0, 6.9, 6.8, 6.8, 6.9, 6.8],
  },
  {
    id: "p2", name: "Pond 2 — Shrimp", species: "Bagda Shrimp", status: "critical",
    do_mg_l: 2.8, ph: 7.1, temp_c: 31.2, turbidity_ntu: 42, salinity_ppt: 14.2, ammonia_mg_l: 0.42,
    battery_pct: 74, signal_pct: 88, farm_id: "f1",
    last_updated: m(2), device_status: "online",
    trend: [5.8, 5.4, 5.0, 4.6, 4.1, 3.8, 3.4, 3.1, 3.0, 2.9, 2.8, 2.8],
  },
  {
    id: "p3", name: "Pond 3 — Tilapia", species: "Tilapia", status: "warning",
    do_mg_l: 4.2, ph: 8.4, temp_c: 30.1, turbidity_ntu: 26, salinity_ppt: null, ammonia_mg_l: 0.18,
    battery_pct: 14, signal_pct: 76, farm_id: "f1",
    last_updated: m(7), device_status: "low_battery",
    trend: [5.6, 5.4, 5.2, 5.0, 4.9, 4.8, 4.6, 4.5, 4.4, 4.3, 4.2, 4.2],
  },
  {
    id: "p4", name: "Pond 4 — Pangas", species: "Pangasius", status: "good",
    do_mg_l: 7.1, ph: 7.6, temp_c: 28.9, turbidity_ntu: 20, salinity_ppt: null, ammonia_mg_l: 0.05,
    battery_pct: 92, signal_pct: 95, farm_id: "f2",
    last_updated: m(5), device_status: "online",
    trend: [6.9, 7.0, 7.0, 7.1, 7.0, 7.1, 7.2, 7.1, 7.0, 7.1, 7.1, 7.1],
  },
  {
    id: "p5", name: "Pond 5 — Carp Mix", species: "Mixed carp", status: "offline",
    do_mg_l: 5.4, ph: 7.3, temp_c: 27.8, turbidity_ntu: 22, salinity_ppt: null, ammonia_mg_l: 0.12,
    battery_pct: 0, signal_pct: 0, farm_id: "f2",
    last_updated: m(185), device_status: "offline",
    trend: [5.5, 5.5, 5.4, 5.4, 5.4, 5.4, 5.4, 5.4, 5.4, 5.4, 5.4, 5.4],
  },
  {
    id: "p6", name: "Pond 6 — Koi", species: "Koi Carp", status: "good",
    do_mg_l: 6.5, ph: 7.5, temp_c: 28.4, turbidity_ntu: 16, salinity_ppt: null, ammonia_mg_l: 0.06,
    battery_pct: 68, signal_pct: 82, farm_id: "f2",
    last_updated: m(4), device_status: "calibration_due",
